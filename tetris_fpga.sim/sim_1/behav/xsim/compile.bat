...
REM
REM Generated by Vivado on Mon Aug 04 22:05:21 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj score_display_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj score_display_tb_vlog.prj -log xvlog.log
