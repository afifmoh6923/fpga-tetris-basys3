...
REM
REM Generated by Vivado on Mon Aug 04 14:25:55 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj vga_controller_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj vga_controller_tb_vlog.prj -log xvlog.log
